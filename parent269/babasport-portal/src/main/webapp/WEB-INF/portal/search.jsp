...
<script>
   ...
   function fqBrand(brandId){
	   //判断是否已选价格
	   if(price!=null && price !=''){
		   window.location.href="/Search?keyword="+keyword+"&price="+price+"&brandId="+brandId;
	   }else{
		...
		<li data-sku="1711416562" class="gl-item">
			<div class="gl-i-wrap">
				...
				<div class="p-name p-name-type-2">
					<a target="_blank" title="满129立减10,199减20优惠券,支持货到付款" href="javascript:;" onclick="window.open('http://localhost:8089/html/product/${product.id}.html')">
						<em>${product.name }</em>
					</a>
				</div>
				<div class="p-commit">
