...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<tbody class="pn-ltbody">
		...
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center">
			<a class="pn-opt" href="/brand/edit.do?id=${brand.id}">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}" href="/brand/deleteBrandById.do?id=${brand.id}">删除</a>
			</td>
		</tr>
	</c:forEach>
